...
public class HoaDon {
    private int maHd; private Date ngayLap; private int maKh; private BigDecimal tongTien;
    public HoaDon() {}
    public int getMaHd() { return maHd; } public void setMaHd(int maHd) { this.maHd = maHd; }
    public Date getNgayLap() { return ngayLap; } public void setNgayLap(Date ngayLap) { this.ngayLap = ngayLap; }
