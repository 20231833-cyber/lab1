...
public class SanPham {
 private int maSp; private String tenSp; private BigDecimal donGia; private int soLuong;
 public SanPham() {}
 public SanPham(int maSp, String tenSp, BigDecimal donGia, int soLuong) { this.maSp = maSp; this.tenSp = tenSp; this.donGia = donGia; this.soLuong = soLuong; }
